...
public class Ejercicio2_CONSULTAR_BD {

	public static void main(String[] args) {
		// 2. Obtener el numero de la etapa y el nombre del ciclista
		// del dorsal que nos de el usuario
		...
		try {
			...
			sql = "SELECT nombre, netapa "
					+ "FROM ciclista c JOIN etapa e ON"
					+ " c.dorsal = e.dorsal "
					+ "where c.dorsal = ?";
			...
			while(rs.next()) {
				vetapa = rs.getInt("netapa");
				vnombre = rs.getString("nombre");
				
				// Interfaz valores salida
				System.out.println(vnombre + " - " + vetapa);
